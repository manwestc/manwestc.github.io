...
*(Figura 2: Synthetic image samples generated with TINTOlib using the TINTO method with blurring. Each image encodes the feature distribution of a tabular instance into a two-dimensional synthetic representation, where the blurring process smooths local feature regions and enhances spatial continuity. These representations are designed to be used as input for computer vision and hybrid neural architectures, enabling tabular data to be processed through image-based deep learning models.)*
