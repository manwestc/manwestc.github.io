...
coupon_url: "https://www.udemy.com/course/programacion-lenguaje-estadistico-r/?couponCode=DIC_2025"
layout: single
show_date: false
read_time: false
share: false
  ...
  <div class="card video-card">
    ...
    <div class="video-wrap">
      <video
        ...
        poster="{{ page.image }}"
      >
        <source src="{{ base_path }}/video/videoPromocional-Prog_R.mp4" type="video/mp4">
