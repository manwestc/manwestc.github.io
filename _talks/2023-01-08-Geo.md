...
<style>
  ...
  .boton-udemy {
    ...
    color: #064e3b !important; /* verde más oscuro y forzado */
  ...
  /* Override a menta para los botones principales del curso */
  .course-wrap .btn-primary{
    background:#a7f3d0;     /* menta */
    color:#065f46;          /* verde oscuro legible */
  }
  .course-wrap .btn-primary:hover{
    background:#86efac;     /* menta un poco más intensa al hover */
  }
</style>
