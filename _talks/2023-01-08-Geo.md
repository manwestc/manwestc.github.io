...
<style>
  ...
  .btn-ghost {
  border: 2px solid rgba(255,255,255,0); /* sin borde blanco */
  background: rgba(0,0,0,0.15); /* fondo semitransparente oscuro */
  color: #e0e7ff !important; /* azul muy claro para texto */
}

.btn-ghost:hover {
  background: rgba(0,0,0,0.3); /* más oscuro al pasar el ratón */
