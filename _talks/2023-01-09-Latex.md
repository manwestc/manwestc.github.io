...
<div style="text-align: center; margin-top: 2rem;">
  <h3 style="margin-bottom: 1rem;">🎯 <strong>Opciones de Acceso</strong></h3>
  <p style="font-size: 1.1em;">Puedes acceder al curso desde Udemy o adquirirlo directamente mediante PayPal:</p>
  ...
  <div style="display: flex; flex-wrap: wrap; justify-content: center; align-items: center; gap: 2rem; margin-top: 2rem;">
    ...
    <!-- Botón PayPal con diseño limpio -->
    <div style="min-width: 300px; max-width: 320px;">
      <div id="paypal-container-TK8M2WRCZEJ8U"></div>
    </div>
  </div>
</div>
...
<script>
  paypal.HostedButtons({
    hostedButtonId: "TK8M2WRCZEJ8U",
  }).render("#paypal-container-TK8M2WRCZEJ8U")
</script>