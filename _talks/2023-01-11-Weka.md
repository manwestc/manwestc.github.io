...
coupon_url: "https://www.udemy.com/course/machine-learning-para-investigacion-con-weka/?couponCode=DIC_2025"
layout: single
show_date: false
read_time: false
share: false
  ...
  <div class="card video-card">
    ...
    <div class="video-wrap">
      <video
        ...
        poster="{{ page.image }}"
      >
        <source src="{{ base_path }}/video/videoPromocional-Weka.mp4" type="video/mp4">
