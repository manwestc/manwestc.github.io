  ...
  <div class="card">
    <h2 class="section-title">🧠 Research and Software Publications</h2>
      ...
      <ul class="pub-list">
        ...
        <li>Jiayun Liu, Manuel Castillo-Cara et al. <strong>A Comprehensive Benchmark of Spatial Encoding Methods for Tabular Data with Deep Neural Networks</strong>. <em>Information Fusion</em>. DOI: <a href="https://doi.org/10.1016/j.inffus.2025.104088" target="_blank" rel="noopener">10.1016/j.inffus.2025.104088</a></li>
